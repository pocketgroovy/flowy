...
- (void)viewDidLoad
{
    ...
    [btnShape setTitle:NSLocalizedString(@"CHOOSE_SHAPE", nil) forState:UIControlStateNormal];
    ...
    [btnColor setTitle:NSLocalizedString(@"CHOOSE_COLOR", nil) forState:UIControlStateNormal];
